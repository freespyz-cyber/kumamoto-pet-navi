...
(() => {
  const events = [
    ...
    },
    {
      ...
      time: '開催時間は主催者情報を確認',
      detail: '県営西公園ドッグラン近くの室内施設で行われる、保護犬・保護猫の合同譲渡会。',
      tags: ['犬猫譲渡会', '室内開催']
    },
    {
      name: '猫たちのための譲渡会',
    ...
    },
    {
      ...
      detail: '爬虫類・両生類の展示、飼育相談、トークショーなどを行うエキゾチックアニマルイベント。',
      tags: ['爬虫類・両生類', '展示・飼育情報']
    },
    {
      name: '2026動物愛護フェスティバルふくおか',
      area: '福岡市中央区・県営天神中央公園',
      lat: 33.590, lng: 130.403,
      start: '2026-11-07', end: '2026-11-07',
      time: '10:45〜15:00',
      detail: '動物愛護トーク、検疫探知犬ステージ、譲渡犬猫の展示、ペット健康相談、体験コーナーを開催。',
      tags: ['入場無料', '健康相談', '動物愛護']
    },
    {
      name: 'わんにゃんよかイベント',
      area: '福岡市中央区・イオンスタイル笹丘',
